...
public class LookupGovernateConfiguration : BaseConfiguration<LookupGovernate>
{
    public override void Configure(EntityTypeBuilder<LookupGovernate> builder)
    {
        base.Configure(builder);
        builder.HasComment("جدول المحافظات");

        builder.Property(e => e.Id).HasComment("معرّف المحافظة");
