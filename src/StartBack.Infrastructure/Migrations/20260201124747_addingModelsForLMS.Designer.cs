...
namespace StartBack.Infrastructure.Migrations
{
    ...
    [Migration("20260201124747_addingModelsForLMS")]
    partial class addingModelsForLMS
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.Tables.AttendancePeriod", b =>
                {
                    ...
                    b.HasIndex("StudentId", "CourseSectionMeetingId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Entities.Models.Tables.CourseSectionMeeting", b =>
                {
                    ...
                    b.HasIndex("CourseSectionId", "MeetingDate", "PeriodId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Entities.Models.Tables.DisciplineIncidentStudent", b =>
                {
                    ...
                    b.HasIndex("IncidentId", "StudentId", "Role")
                        .IsUnique();
            ...
            modelBuilder.Entity("Entities.Models.Tables.FinalGrade", b =>
                {
                    ...
                    b.Property<DateTime?>("PostedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasComment("تاريخ النشر");

                    b.Property<int?>("PostedBy")
                        .HasColumnType("integer")
                        .HasComment("نشر بواسطة");
            ...
            modelBuilder.Entity("Entities.Models.Tables.StaffUniversityAssignment", b =>
                {
                    ...
                    b.HasIndex("StaffId", "UniversityId", "AcademicYearId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Entities.Models.Tables.StudentEnrollment", b =>
                {
                    ...
                    b.Property<int>("LookupEnrollmentCodeId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LookupEnrollmentCodeId");

                    b.HasIndex("PersonUniversityId");

                    b.HasIndex("SectionId");

                    b.ToTable("StudentEnrollment", t =>
                        {
                            t.HasComment("جدول سجل قيد الطلاب وتاريخ التسجيل");
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.Tables.StudentGpa", b =>
                {
                    ...
                    b.HasIndex("StudentId", "AcademicYearId", "SemesterId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Entities.Models.Tables.StudentGuardian", b =>
                {
                    ...
                    b.HasIndex("StudentId", "GuardianId", "RelationshipTypeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Entities.Models.Tables.AssignmentGrade", b =>
                {
                    ...
                    b.HasOne("Entities.Models.Tables.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("Entities.Models.Tables.AttendanceCompleted", b =>
                {
                    ...
                    b.HasOne("Entities.Models.Tables.Staff", "Staff")
                        .WithMany()
            ...
            modelBuilder.Entity("Entities.Models.Tables.DisciplineAction", b =>
                {
                    ...
                    b.HasOne("Entities.Models.Tables.Staff", "Issuer")
                        .WithMany()
            ...
            modelBuilder.Entity("Entities.Models.Tables.DisciplineIncident", b =>
                {
                    ...
                    b.HasOne("Entities.Models.Tables.Staff", "Reporter")
                        .WithMany()
            ...
            modelBuilder.Entity("Entities.Models.Tables.StudentEnrollment", b =>
                {
                    b.HasOne("Entities.Models.Tables.LookupEnrollmentCode", "LookupEnrollmentCode")
                        .WithMany("StudentEnrollments")
                        .HasForeignKey("LookupEnrollmentCodeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("LookupEnrollmentCode");
